...
async def to_code(config):
    ...
    # Añadir las opciones de sdkconfig necesarias
    #cg.add_build_flag("-DIP_NAPT=1")
    #cg.add_build_flag("-DIP_NAPT_PORTMAP=1")
    #cg.add_build_flag("-DLWIP_IPV4_NAPT=1")
    #cg.add_build_flag("-DCONFIG_LWIP_IP_NAPT=1")
    #cg.add_build_flag("-DCONFIG_LWIP_IP_FORWARD_ALLOW_TX_ON_RX_NETIF=1")

    #cg.add_define("CONFIG_LWIP_IP_FORWARD", "y")
    #cg.add_define("CONFIG_LWIP_IPV4_NAPT", "y")
    #cg.add_define("CONFIG_LWIP_IPV4_NAPT_PORTMAP", "y")
    #cg.add_define("CONFIG_LWIP_DHCP_OPTIONS", "y")
    #cg.add_define("CONFIG_LWIP_DHCPS", "y")
    #cg.add_define("CONFIG_LWIP_DHCP_DOES_ACD_CHECK", "y")
    #cg.add_define("CONFIG_LWIP_DHCPS_STATIC_ENTRIES", "y")
    #cg.add_define("CONFIG_LWIP_DHCPS_ADD_DNS", "y")
    #cg.add_define("CONFIG_LWIP_DHCP_DISABLE_VENDOR_CLASS_ID", "y")
    #cg.add_define("CONFIG_ESP_WIFI_SOFTAP_SUPPORT", "y")
    #cg.add_define("CONFIG_LWIP_L2_TO_L3_COPY", "y")
    #cg.add_define("CONFIG_LWIP_MEMP_NUM_NETCONN", "12")
    #cg.add_define("CONFIG_LWIP_MEMP_NUM_TCP_PCB", "12")
    #cg.add_define("CONFIG_LWIP_TCP_SND_BUF", "8192")
    #cg.add_define("CONFIG_LWIP_TCP_WND", "8192")
